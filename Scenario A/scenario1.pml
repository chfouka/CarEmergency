...
State-vector 96 byte, depth reached 68, errors: 0
     2625 states, stored
     4753 states, matched
     7378 transitions (= stored+matched)
       12 atomic steps
hash conflicts:         0 (resolved)

Stats on memory usage (in Megabytes):
    0.260	equivalent memory usage for states (stored*(State-vector + overhead))
    0.379	actual memory usage for states
   64.000	memory used for hash table (-w24)
    0.305	memory used for DFS stack (-m10000)
   64.598	total actual memory usage
